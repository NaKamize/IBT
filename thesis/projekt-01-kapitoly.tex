...
Pomocou argumentov si užívateľ môže zvoliť variácie, ktoré sa budú vytvárať. Spracovanie argumentov zabezpečuje trieda \textit{ArgParser}. Hlavnou metódou tejto triedy je \textit{parse}. Cieľom tejto metódy je overiť správnosť argumentov a uložiť zadané argumenty. Jednotlivé variácie majú pridelené nasledujúce argumenty:

\begin{itemize}\itemsep0.05em
    \item -r, -{}-repetition
    \item -t, -{}-transposition
    \item -S, -{}-sequence-up
    \item -c, -{}-contrary\_motion
    \item -R, -{}-retro\_gradation
    \item -a, -{}-augmentation
    \item -d, -{}-diminution
\end{itemize}

\subsection{Spracovanie vstupu a výstupu}
\subsection{Zásobnik}
\subsection{Tvorba variácií}
\subsection{Prehranie výstupu}

\section{Vstupy a výstupy}
\section{Výsledky a porovnanie}
=======
>>>>>>> parent of 5ced66b (Removed template figues.)
\chapter{Záver}
\label{chap:end}
