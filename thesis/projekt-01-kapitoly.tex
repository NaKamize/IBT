...
Prechodné pole vieme limitovať dlžkou 2. Je to vďaka tomu, že v jednom čase na základe našej gramatiky bude obsahovať maximálne 2 neterminály. V poli každý element $i$ ukazuje na jeden neterminál vo vnútri zásobniku. Na začiatku je pole inicializované aby ukazovalo na prvý neterminál S.
