...
Môžeme si všimnúť, že stále zanedbávame dlžky jednotlivých tónov. Riešenie bude prezentované v nadchádzajúcej kapitole.
...
\begin{enumerate}[label=\arabic*)]
    ...
    \item Druhá LL podmienka. Majme dve rozdielne pravidlá $$(A_1,A_2, ...,A_m) \rightarrow (x_1, x_2, ..., x_m) \in P$$ a $$(B_1, B_2, ..., B_n) \rightarrow (y_1, y_2, ..., y_n),$$ ktoré splňujú podmienku $A_1 = B_1$, platí že $$prv\acute{y}(pjadro(G),x_1) \cap prv\acute{y}(pjadro(G),y_1) = \emptyset$$
\end{enumerate}
