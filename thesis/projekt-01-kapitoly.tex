...
Pomocou tejto operácie vkladáme prvé častí z pravých strán pravidiel gramatiky s rozptýleným kontextom. Tie sú vkladane na vrch zásobníka. Pod nimi rozumieme tóny hlavnej témy alebo skladby, ktorú chce užívateľ variovať.
...
\subsubsection*{def insert()}

\subsubsection*{def remove(symbol)}
